...
def main(filename):
    ...
    #ejemplo concreto algo de google en el universal
    #df=_eliminate_google_00(df)
    ...
    return df
#def _eliminate_google_00(df):
    #primer=df.iloc[0,0]
    #df.iloc[0,0]=primer[98:]
    #return df
...
def _add_newspaper_uid_column(df,newspaper_uid):
    logger.info('Filling nespaper_uid column with {}'.format(newspaper_uid))
